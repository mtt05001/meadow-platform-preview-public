...
export function extractClientData(submission: Record<string, unknown>): ClientData {
  ...
  return {
    ...
    alcohol: str(getAnswer(answers, "28")) || str(getAnswer(answers, "199")),
    tobacco: str(getAnswer(answers, "30")) || str(getAnswer(answers, "201")),
    cannabis: str(getAnswer(answers, "31")) || str(getAnswer(answers, "202")),
    caffeine: str(getAnswer(answers, "32")) || str(getAnswer(answers, "200")),
